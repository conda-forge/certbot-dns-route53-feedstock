About certbot-dns-route53-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-dns-route53-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-dns-route53-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-dns-route53
# for installing globally
pixi global install certbot-dns-route53
```
...
It is possible to list all of the versions of `certbot-dns-route53` available on your platform:
...
```
pixi search certbot-dns-route53 --channel conda-forge
```
